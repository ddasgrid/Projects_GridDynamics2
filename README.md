...
# 3. Download model weights (hosted on Google Drive — exceeds GitHub's 100MB limit)
 Link to Drive where model weights are stored:[ https://drive.google.com/drive/folders/1G8HXVayxYRuoW8L-69jry8BzTed1pGZP?usp=sharing](https://drive.google.com/drive/folders/1G8HXVayxYRuoW8L-69jry8BzTed1pGZP?usp=sharing)
