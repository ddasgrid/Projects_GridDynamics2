...
def apply_text_attack_with_concept(
    ...
    if use_auto_mode:
        requested_mode = CONCEPT_TO_ATTACK.get(concept, "paraphrase")
    else:
        requested_mode = str(manual_mode) if manual_mode else "paraphrase"
        if requested_mode not in TEXT_ATTACK_MODES:
            requested_mode = "paraphrase"
                ...
                if checkpoint is None:
                    ...
                    try:
                        ...
                        if apply_text_attack:
                            ...
                            text_attack_requested = attack_meta["requested_mode"]
                        ...
                        result = {
                            ...
                            "text_attack_requested": text_attack_requested,
    ...
    with col2:
        with st.container(border=True):
            ...
            if notice:
                ...
                st.write(f"- Requested text attack: `{result['text_attack_requested']}`")
